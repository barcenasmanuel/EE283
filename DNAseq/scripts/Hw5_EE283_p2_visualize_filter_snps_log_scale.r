...
p <- ggplot(plot_data, aes(x = Step)) +
  ...
  theme_minimal() +
  labs(title = "SNP Counts and Losses After Each Filtering Step (Log Scale)",
       x = "Filtering Step",
...
# Save the plot
ggsave("/pub/mbarcen1/EE283/DNAseq/output/snp_results/advanced_filtered_snps/snp_filtering_loss_plot_log_scale.png", 
...
cat("The y-axis is log-scaled to better visualize the large differences between steps.\n")